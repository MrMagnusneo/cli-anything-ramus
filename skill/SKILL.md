...
bundle this skill came from:

```bash
bash {{BUNDLE_DIR}}/install.sh
```

It sets up the CLI, the Ramus engine and this skill, then verifies them.
`{{BUNDLE_DIR}}/AGENT_INSTALL.md` describes every step.
...
Everything lives in the bundle this skill was installed from:

- Install / reinstall / verify: `{{BUNDLE_DIR}}/AGENT_INSTALL.md`, `{{BUNDLE_DIR}}/install.sh --check`
- Full CLI documentation: `{{BUNDLE_DIR}}/source/cli_anything/ramus/README.md`
- Tests and recorded results: `{{BUNDLE_DIR}}/source/cli_anything/ramus/tests/TEST.md`
- Codebase analysis and design rationale: `{{BUNDLE_DIR}}/source/RAMUS.md`
- Worked example: `{{BUNDLE_DIR}}/examples/order_fulfilment.sh`
